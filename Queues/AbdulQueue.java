...
import Chapter16.customExceptions.QueueEmptyException;
import Chapter16.customExceptions.QueueFullException;

public class AbdulQueue<S> {
	private Object [] elements;
	private int lastIndexAddedTo;
	private int lastIndexDeletedFrom;
	public AbdulQueue(int size) {
